                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                data-bs-target=".bd-example-modal-lg">ADD EXPENSE CATEGORY</button>

                            <div class="table-responsive">
                                <table class="display" id="expense_category-table">
                                    <thead>
                                        <tr>
                                            <th>Sl no</th>
                                            <th>Category Name</th>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">ADD EXPENSE CATEGORY</h4>
