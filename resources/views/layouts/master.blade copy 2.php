                                ...
                                <li class="menu-box">
                                    <ul>
                                        <li class="sidebar-list">
                                            ...
                                            <ul class="sidebar-submenu">
                                                <li> <a href="#"></i>Transaction
                                                        Reports</a>
                                                </li>
                                                <li> <a href="#"></i>Purchase
                                                        Reports</a>
                                                </li>
                                                <li> <a href="#"></i>Expense
                                                        Reports</a>
                                                ...
                                                <li> <a href="#"></i>Ledger Reports</a>
                                                </li>
                                                <li> <a href="#"></i>Balance Sheet
                                                        Reports</a>
                                                </li>
                                                <li> <a href="#"></i>Profit and Loss
                                                        Reports</a>
                                                </li>
                                            </ul>
                                        </li>
